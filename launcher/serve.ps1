# Rare Friends: Expeditions - local launcher for Windows.
...
if (-not $listener) {
    Write-Host 'Could not open a local port (4173-4192 are busy).' -ForegroundColor Red
    Read-Host 'Press Enter to close'
    exit 1
}
...
Write-Host ''
Write-Host '  Rare Friends: Expeditions' -ForegroundColor Green
